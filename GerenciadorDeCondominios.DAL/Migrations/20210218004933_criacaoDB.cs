    ...
    public partial class criacaoDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServicosPredio", x => x.ServicoPredioId);
                    table.ForeignKey(
                        name: "FK_ServicosPredio_Servicos_ServicoId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "6b2bc359-ec25-43c8-be00-69f9b29a1900", "602170bd-40f8-47b7-8cf5-6ce0378b5c74", "Morador do prédio", "Morador", "MORADOR" },
                    { "d0630c67-3448-439c-9a08-366ad946a67d", "2ea35e16-4a38-4ad6-98b4-42dd596c67d3", "Síndico do prédio", "Sindico", "SINDICO" },
                    { "e44d5271-2fed-41bb-847d-c91a35b21e28", "65e47a7a-f96c-477c-9608-789cf65a3669", "Administrador do prédio", "Administrador", "ADMINISTRADOR" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServicosPredio_ServicoId",
                table: "ServicosPredio",
                column: "ServicoId");
